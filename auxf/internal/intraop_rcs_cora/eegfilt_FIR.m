% eegfilt_FIR1() -  (high|low|band)-iass filter data using two-way least-squares 
...
function [smoothdata,filtwts] = eegfilt_FIR1(data,srate,locutoff,hicutoff,epochframes,filtorder, revfilt)
...
filtwts=fir1(filtorder,f(3:4));%%%%%%%%%%%%%%%%%%%%%%FIR1 instead of FIRLS
