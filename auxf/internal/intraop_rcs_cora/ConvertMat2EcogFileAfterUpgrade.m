...
function ConvertMat2EcogFileAfterUpgrade(EcogFileName)
...
% %%% remove
% try
% ecog.contact(15).raw_signal =  double(CECOG_2___13___Array_1___29);
% ecog.Fs(15) =  CECOG_2___13___Array_1___29_KHz*1000;
% ecog.contact(16).raw_signal =  double(CECOG_2___14___Array_1___30);
% ecog.Fs(16) =  CECOG_2___14___Array_1___30_KHz*1000;
% end
% if ~isempty(strfind(EcogFileName,'lfp'))
% lfp.contact(1).raw_signal =  double(CECOG_1___15___Array_1___15);
% lfp.Fs(1) =  CECOG_1___15___Array_1___15_KHz*1000;
% lfp.contact(2).raw_signal =  double(CECOG_1___16___Array_1___16);
% lfp.Fs(2) =  CECOG_1___16___Array_1___16_KHz*1000;
% end
