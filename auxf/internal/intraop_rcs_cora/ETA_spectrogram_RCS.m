function ETA_spectrogram_RCS(name,ecog,trial_onset)
...
n_data_ch=length(ecog.contact)-1;
...
saveas(gcf,[name(1:end-5) '_ETA.fig']);
...
save([name(1:end-5) '_ETA.mat'], 'S_mag_median', 'S_mag_mean','WINDOW','NOVERLAP','NFFT','FRAME_ADVANCE','PRE','POST','ADD','BL');
end
