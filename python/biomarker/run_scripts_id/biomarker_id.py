...
def gen_config(p_data: pathlib.Path, f_data: str, p_output: pathlib.Path,
               str_subject: _VEC_STR_SUBJECT='RCS02', str_side: _VEC_STR_SIDE='R',
               stim_level: dict|MappingProxyType=MappingProxyType(dict()), 
               label_type: _VEC_MED_LEVEL='med', n_rep: int=5, bool_debug: bool=False, 
               bool_use_ray: bool=True, bool_use_gpu: bool=False, bool_force_sfs_acc: bool=False,
               str_model: str='LDA', str_metric: _VEC_STR_METRIC='avg_auc', 
...
def biomarker_id_side(cfg: dict):
