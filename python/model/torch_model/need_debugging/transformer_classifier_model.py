from .transformer_classifier_utils import *
from .base import BaseTorchTrainer, BaseTorchModel, BaseTorchClassifier
from .mlp_model import TorchMLPTrainer

"""
Credit: https://github.com/mselmangokmen/TimeSeriesProject/tree/main
"""


class TransformerClassifier(nn.Module, BaseTorchClassifier):
    def __init__(
        self,
        device,
        d_model=100,
        ...
        self.classHead = ClassificationHead(
            seq_len=seq_len, d_model=d_model, details=details, n_classes=5
        )
