function rawDataFilt = signalFiltBandstop(rawData, filtOrder, ...
    cutoffFreqLow, cutoffFreqHigh, fs)
%% signalUtils script - bandstop filters the signal
% Bandstop filters the input data using the MATLAB designfilt and FIR
