function rawDataFilt = signalFiltHighpass(rawData, filtOrder, ...
    cutoffFreq, fs)
%% signalUtils script - highpass filters the signal
% Highpass filters the input data using the MATLAB designfilt and FIR
...
maxTBWArray = cutoffFreq; % Band-/highpass
